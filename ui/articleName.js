...
function loadCommentForm () {
    var commentFormHtml = `
        ...
        <textarea class="message" id="comment_text" rows="5" cols="100" placeholder="Enter your comment here..."></textarea>
        <br/>
...
//         request.open('GET','http://thivyak.imad.hasura-app.io/submit-comment/?comment=' + comment,true);
//         request.send(null);
